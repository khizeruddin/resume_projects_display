Project Description: Predictive Modeling ML algorithm and Dashboard Development for Scrap Reduction in Tire manufacturing

The model is trained/calibrated on sample data and its efficiency and accuracy, with predicted values from forecasts are the end values.
